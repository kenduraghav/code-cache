...
public class SnippetDAO {
	...
	public void create(Snippet snippet) {
        String sql = "INSERT INTO snippets (id, code, language, description, tags) VALUES (?, ?, ?, ?, ?)";
    ...
    public void update(Snippet snippet) {
        String sql = "UPDATE snippets SET code = ?, language = ?, description = ?, tags = ? WHERE id = ?";
    ...
    public List<Snippet> search(String query) {
        ...
        String sql = """
            ...
            WHERE code LIKE ? OR description LIKE ? OR language LIKE ? OR tags LIKE ?
